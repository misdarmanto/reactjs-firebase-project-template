...
const StockCreateView = (): JSX.Element => {
  ...
  return (
    <MainLayout>
      ...
      <div className="bg-white rounded p-5 sm:p-10">
        ...
        <div className="sm:my-6 flex flex-col sm:flex-row gap-5">
          <div className="w-full sm:w-1/2">
            <label className="block mb-2 text-sm font-medium text-gray-900">Batch</label>
            <input
              type="text"
              value={batch}
              onChange={(e) => {
